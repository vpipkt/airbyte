...
@JsonSubTypes(
    JsonSubTypes.Type(value = MsSqlServerCdcReplicationConfigurationSpecification::class, name = "CDC"),
    JsonSubTypes.Type(value = MsSqlServerCursorBasedReplicationConfigurationSpecification::class, name = "STANDARD"),
)
...
class MsSqlServerCdcReplicationConfigurationSpecification : MsSqlServerReplicationMethodConfigurationSpecification {
    init {
        log.info {"initializing MsSqlServerCdcReplicationConfigurationSpecification"}
    }
...
class MsSqlServerCursorBasedReplicationConfigurationSpecification : MsSqlServerReplicationMethodConfigurationSpecification {
    init {
        log.info {"initializing MsSqlServerCursorBasedReplicationConfigurationSpecification"}
    }
}
